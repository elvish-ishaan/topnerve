...
const ContactUs = () => {
  return (
    <div className="min-h-screen bg-slate-900 py-12 w-full flex justify-center items-center">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full ml-48">
